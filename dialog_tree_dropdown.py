"""Reusable dropdown widget for dialog tree nodes.

Filtered keyboard-navigable dropdown with scrollbar.
Extracted from DialogTreePanel (dialog_tree_panel.py) for reuse.
"""
...
class TreeDropdown:
    """Filtered dropdown with keyboard navigation and scrollbar."""
    ...
    def __repr__(self):
        return f"TreeDropdown({self._selected})"
